...
- 2026-06-02 : besoin "Sélection de rôles à l'arrivée" spécifié (need role-selector-on-join.md + TASK-39), statut ready-to-dev. StringSelectMenu multi-choix sous embed bienvenue, GuildRole en BDD, /config role add/remove/list.
